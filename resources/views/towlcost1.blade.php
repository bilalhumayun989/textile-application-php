...
@section('title','Towel Cost 1')

@section('content')
<div class="container mt-5">
    <h2>Towel Cost Calculator 1</h2>
    <form method="POST" action="{{ route('towlcost1.store') }}">
        @csrf
    ...
    <div class="mt-3 d-flex justify-content-between">
        ...
        {{-- <a href="{{ route('towlcost2.index') }}" class="btn btn-secondary">Next → Towel Cost 2</a> --}}
    </div>
